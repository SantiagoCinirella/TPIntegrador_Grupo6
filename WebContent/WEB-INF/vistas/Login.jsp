...
<body translate="no">
	<form class="login" method="get" action="altaDeUsuarios.html">
		<input type="text" placeholder="Usuario" name="txtUsuario" required> <input
			type="password" placeholder="Contraseña" name="txtPassword" required> <input
			type="submit" value="Login" name="btnLogin">
	</form>
</body>
</html>
