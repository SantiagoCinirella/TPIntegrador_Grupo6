  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.html"><h2>BANCO UTN FRGP</h2></a>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <h2>Por que ser parte de <em>BANCO UTN FRGP?</em></h2>
            </div>
          </div>
          <div class="col-md-4">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="count-area-content">
                  <div class="count-digit">464</div>
                  <div class="count-title">Sucursales</div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="count-area-content">
                  <div class="count-digit">9000</div>
                  <div class="count-title">Empleados</div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="count-area-content">
                  <div class="count-digit">50000</div>
              ...
              <div class="col-md-6">
                <div class="count-area-content">
                  ...
                  <div class="count-title">Provincias</div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6 align-self-center">
                  <div class="right-content">
                    ...
                    <p>BANCO UTN FRGP comenz� a operar en 1985 como agente de mercado abierto, especializado en trading de t�tulos p�blicos, pases y otras operaciones financieras.
