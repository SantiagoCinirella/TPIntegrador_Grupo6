...
public class main {
	...
	public static void main(String[] args) {
		...
		NegCuenta negCuenta = null;
		NegMovimiento negmovimiento = null;
		NegPersona negPersonas = null;
		
		cargarPersonas(negPersonas);
		cargarCuentas(negCuenta);
		cargarMovimientos(negmovimiento);
	}
	
	private static void cargarMovimientos(NegMovimiento negmovimiento) {

		negmovimiento = new NegMovimiento();
	...
	private static void cargarCuentas(NegCuenta negCuenta)
	{
		//# cbu, alias, dni, estado, fechaCreacion, nroCuenta, saldo, tipoCuenta

		negCuenta = new NegCuenta();
		...
		//'1000001', 'condor.celular', '18000000', '0', '2021-06-27T22:33:18.673', '5000001', '10000', 'Caja de ahorro en pesos'
		...
		//'1000002', 'pa�o.azul', '19000000', '0', '2021-06-27T22:33:45.302', '5000002', '10000', 'Caja de ahorro en dolares'
		...
		//'1000003', 'cuchillo.plato', '22222222', '0', '2021-06-27T22:35:48.002', '5000003', '10000', 'Caja de ahorro en dolares'
		...
		//'1000004', 'cuctenedor.cubierto', '44444444', '0', '2021-06-27T22:36:12.359', '5000004', '10000', 'Caja de ahorro en dolares'
		...
		//'1000005', 'plato.verde', '55555555', '0', '2021-06-27T22:36:24.511', '5000005', '10000', 'Caja de ahorro en pesos'
		...
		//'1000006', 'calor.frio', '66666666', '0', '2021-06-27T22:36:38.190', '5000006', '10000', 'Caja de ahorro en pesos'
		...
		//'1000007', 'termo.negro', '77777777', '0', '2021-06-27T22:36:53.771', '5000007', '10000', 'Caja de ahorro en pesos'
		...
		//'1000008', 'cancion.nube', '88888888', '0', '2021-06-27T22:37:09.607', '5000008', '10000', 'Caja de ahorro en pesos'
		...
		//'1000009', 'estrella.cielo', '99999999', '0', '2021-06-27T22:47:04.978', '5000009', '10000', 'Caja de ahorro en dolares'
		...
		//'1000010', 'estrella.cielo', '88888888', '0', '2021-06-27T22:48:12.055', '5000010', '10000', 'Caja de ahorro en dolares'
		...
		for (Cuenta cuenta2 : listaCuentas) {
			...
			negCuenta.agregarCuenta(cuenta2);
		}
		
	}
	
	private static void cargarPersonas(NegPersona negPersonas)
	{
		negPersonas = new NegPersona();
		...
		//	'18000000', 'Mclaughlin', 'Afganistán 123', 'Etiam.bibendum@nislMaecenasmalesuada.org', '0', '13-12-1990', 'capital', 'Argentina', 'Ishmael', 'Buenos Aires', 'Masculino'
		...
		//	'19000000', 'Steele', 'Albania 123', 'id@vitaesodales.com', '0', '14-12-1990', 'capital', 'Argentina', 'Ronan', 'Buenos Aires', 'Masculino'
		...
		//	'22222222', 'Dickson', 'Alemania 123', 'tortor.Nunc.commodo@Donec.org', '0', '15-12-1990', 'capital', 'Argentina', 'Carter', 'Buenos Aires', 'Masculino'
		...
		//	'33333333', 'admin', 'Andorra 123', 'admin@admin.com', '0', '16-12-1990', 'capital', 'Argentina', 'admin', 'Buenos Aires', 'Masculino'
		...
		//	'44444444', 'Obrien', 'Angola 123', 'quam.vel@lacus.org', '0', '17-12-1990', 'capital', 'Argentina', 'Xerxes', 'Buenos Aires', 'Masculino'
		...
		//'55555555', 'Holden', 'Argelia 123', 'eget.odio.Aliquam@Curabitur.edu', '0', '18-12-1990', 'capital', 'Argentina', 'Hunter', 'Buenos Aires', 'Femenino'
		...
		//	'66666666', 'Nicholson', 'Argentina 123', 'laoreet@afacilisis.edu', '0', '19-12-1990', 'capital', 'Argentina', 'Riley', 'Buenos Aires', 'Femenino'
		...
		//	'77777777', 'Green', 'Armenia 123', 'Curabitur.egestas.nunc@ornare.edu', '0', '20-12-1990', 'capital', 'Argentina', 'Brent', 'Buenos Aires', 'Femenino'
		...
		//	'88888888', 'Murray', 'Australia 123', 'tempor.est.ac@loremsit.edu', '0', '21-12-1990', 'capital', 'Argentina', 'Hoyt', 'Buenos Aires', 'Femenino'
		...
		//	'99999999', 'Mclaughlin', 'Austria 123', 'Duis@sagittisDuisgravida.net', '0', '22-12-1990', 'capital', 'Argentina', 'Ishmael', 'Buenos Aires', 'Femenino'*/
		...
		for (Persona persona2 : listaPersonas) {
			...
			negPersonas.agregarPersona(persona2);
		}
